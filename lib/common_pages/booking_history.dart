            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height:10),
                  Text('Check In: ${DateFormat('yMMMMd').format(booking['checkinDate'])}', style: kBoldDarkTextSize18,),
                  const SizedBox(height:10),
                  Text('Check Out: ${DateFormat('yMMMMd').format(booking['checkoutDate'])}', style: kBoldDarkTextSize18,),
                  const SizedBox(height:10),
